...
void Terrain::calculateNormals()
{
	...
	for(int q = 0; q < this->SIZE; q++)
	{
		for(int u = 0; u < this->SIZE; u++)
		{
			...
			{
				D3DXVECTOR3 v1 = verts[e].pos - verts[a].pos;
				D3DXVECTOR3 v2 = verts[b].pos - verts[d].pos;
				Vector3 v = Vector3(v1.x, v1.y, v1.z).GetCrossProduct(Vector3(v2.x, v2.y, v2.z));
				verts[q * this->SIZE + u].normal = D3DXVECTOR3(v.x, v.y, v.z);
			}
		}
	}
}