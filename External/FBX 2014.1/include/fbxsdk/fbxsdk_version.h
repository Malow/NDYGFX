...
#define FBXSDK_VERSION_MAJOR	2014		//integer
#define FBXSDK_VERSION_MINOR	1			//integer
#define FBXSDK_VERSION_POINT	0			//integer
#define FBXSDK_VERSION_NAME		"Beta"		//string, ex: Alpha1, Alpha2, Beta1, Beta2, RC, Release
#define FBXSDK_VERSION_DATE		20130205	//yyyymmdd
...
//FBX SDK namespace definition
	...
	#define FBXSDK_NAMESPACE fbxsdk_2014_1_beta
#else
